    ...
    palette: {
      ...
      page: {
        ...
        effects: {
          ...
          layerOneOpacity: 0.88,
          layerOneBlend: "screen",
          layerOneSize: "130% 130%",
          layerTwo:
            "radial-gradient(circle at 20% 35%, rgba(61, 232, 255, 0.34) 0%, transparent 48%), radial-gradient(circle at 78% 62%, rgba(255, 79, 216, 0.3) 0%, transparent 50%), linear-gradient(110deg, transparent 0%, rgba(61, 232, 255, 0.2) 45%, transparent 100%)",
          layerTwoAnimation: "themeNeonFlicker 7s steps(20, end) infinite",
          layerTwoOpacity: 0.96,
          layerTwoBlend: "screen",
          layerTwoFilter: "blur(0.6px)",
          layerTwoSize: "120% 120%",
        },
      },
    },
  },
  ...
  "aurora-premium": {
    ...
    palette: {
      ...
      page: {
        ...
        effects: {
          layerOne:
            "linear-gradient(110deg, rgba(99, 247, 217, 0.2) 8%, transparent 36%, rgba(131, 168, 255, 0.24) 58%, transparent 82%), radial-gradient(circle at 24% 44%, rgba(99, 247, 217, 0.3) 0%, transparent 48%), radial-gradient(circle at 78% 58%, rgba(131, 168, 255, 0.26) 0%, transparent 52%)",
          layerOneAnimation: "themeAuroraRibbon 20s ease-in-out infinite alternate",
          layerOneOpacity: 0.92,
          layerOneBlend: "screen",
          layerOneSize: "150% 150%",
          layerTwo:
            "radial-gradient(circle at 14% 26%, rgba(147, 255, 227, 0.24) 0%, transparent 42%), radial-gradient(circle at 84% 34%, rgba(167, 189, 255, 0.22) 0%, transparent 44%), radial-gradient(circle at 52% 62%, rgba(114, 255, 220, 0.14) 0%, transparent 40%)",
          layerTwoAnimation: "themeAuroraShimmer 10s ease-in-out infinite",
          layerTwoOpacity: 0.9,
          layerTwoBlend: "screen",
          layerTwoFilter: "blur(1.1px)",
          layerTwoSize: "140% 140%",
        },
      },
    },
  },
  "inferno-premium": {
    ...
    palette: {
      ...
      page: {
        ...
        effects: {
          layerOne:
            "radial-gradient(circle at 12% 112%, rgba(255, 128, 39, 0.46) 0%, transparent 42%), radial-gradient(circle at 34% 108%, rgba(255, 183, 94, 0.34) 0%, transparent 36%), radial-gradient(circle at 58% 114%, rgba(255, 98, 38, 0.42) 0%, transparent 40%), radial-gradient(circle at 78% 110%, rgba(255, 151, 70, 0.34) 0%, transparent 36%)",
          layerOneAnimation: "themeFlameRise 6.8s ease-in-out infinite",
          layerOneOpacity: 0.98,
          layerOneBlend: "screen",
          layerOneSize: "100% 100%",
          layerTwo:
            "linear-gradient(0deg, rgba(255, 138, 43, 0.26) 0%, transparent 46%), radial-gradient(circle at 26% 48%, rgba(255, 138, 43, 0.3) 0%, transparent 45%), radial-gradient(circle at 70% 62%, rgba(255, 209, 102, 0.26) 0%, transparent 52%)",
          layerTwoAnimation: "themeHeatHaze 9s ease-in-out infinite alternate",
          layerTwoOpacity: 0.9,
          layerTwoBlend: "screen",
          layerTwoFilter: "blur(1.2px)",
          layerTwoSize: "120% 120%",
        },
      },
    },
    ...
    palette: {
      ...
      page: {
        ...
        effects: {
          ...
          layerOneOpacity: 0.94,
          layerOneBlend: "screen",
          layerOneSize: "100% 100%",
          layerTwo:
            "radial-gradient(circle at 24% 42%, rgba(97, 121, 205, 0.24) 0%, transparent 42%), radial-gradient(circle at 74% 30%, rgba(200, 169, 95, 0.24) 0%, transparent 42%), radial-gradient(circle at 58% 72%, rgba(76, 210, 255, 0.18) 0%, transparent 44%)",
          layerTwoAnimation: "themeGalaxyTwinkle 8s ease-in-out infinite alternate",
          layerTwoOpacity: 0.88,
          layerTwoBlend: "lighten",
          layerTwoFilter: "blur(1px)",
